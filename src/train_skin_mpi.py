...
def train(args):
    ...
    if args.val_data_list:
        val_loader = get_dataloader(
            ...
            batch_size=args.batch_size,
            shuffle=False,
            sampler=SamplerMix(num_samples=1024+512, vertex_samples=512+256),
            transform=transform,
        )
...
def main():
    ...
    parser.add_argument('--model_name', type=str, default='ptcnn', choices=['ptcnn', 'pct', 'pct2', 'pct3','pctlast'], help='Model architecture to use')
    ...
    parser.add_argument('--lr_end', type=float, default=1e-5, help='Final learning rate (at the end of training)')
    parser.add_argument('--lr_warmup_epochs', type=int, default=10, help='Number of epochs to keep the initial learning rate')
    parser.add_argument('--output_dir', type=str, default='output/skin_mpi', help='Directory to save output files')
