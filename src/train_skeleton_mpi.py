...
def train(args):
    ...
    for epoch in range(args.epochs):
        ...
        for batch_idx, data in enumerate(train_loader):
            ...
            cd_loss = criterion2(outputs, joints_flat)
            sym_loss = sym_loss_fn(outputs)
            loss = loss_main + cd_loss+args.symmetry_weight * sym_loss
...
def main():
    ...
    # Output parameters
    parser.add_argument('--output_dir', type=str, default='output/skeleton_mpi', help='Directory to save output files')
